...
class CheckCommentLikedUseCase implements UseCaseInterfacae {
  final CommentLikesRepository commentLikesRepository;

  CheckCommentLikedUseCase({required this.commentLikesRepository});
  ...
  Future<bool> execute([Map<String, dynamic>? params]) async {
    try {
      ...
      return await commentLikesRepository.checkLiked(request: request);
    } catch (e) {
