...
class CheckLikedUseCase implements UseCaseInterfacae {
  final LikesRepository likesRepository;

  CheckLikedUseCase({required this.likesRepository});
  ...
  Future<bool> execute([Map<String, dynamic>? params]) async {
    try {
      ...
      return await likesRepository.checkLiked(request: request);
    } catch (e) {
